      ...
      <div>
        {!hasData ? (
          ...
          safeDimensions.map((dimension) => {
            ...
            const numericExtent =
              dimension.kind === "numeric" ? numericExtents.get(dimension.id) : undefined;
            const datetimeExtent =
              dimension.kind === "datetime" ? datetimeExtents.get(dimension.id) : undefined;
